...
interface TrivyIcons {
    companion object {
        ...
        val CloudFormation: Icon = IconLoader.getIcon("/icons/cloudformation.svg", TrivyIcons::class.java)
        ...
        val Unidentified: Icon = IconLoader.getIcon("/icons/trivy.svg", TrivyIcons::class.java)
    }
}