...
class Finding {
  @JsonProperty("rule_id") var RuleID: String? = null

  @JsonProperty("long_id") var LongID: String? = null

  @JsonProperty("rule_description") var RuleDescription: String? = null

  @JsonProperty("rule_provider") var Provider: String? = null

  @JsonProperty("rule_service") var Service: String? = null

  @JsonProperty("impact") var Impact: String? = null

  @JsonProperty("resolution") var Resolution: String? = null

  @JsonProperty("links") var Links: List<String>? = null
